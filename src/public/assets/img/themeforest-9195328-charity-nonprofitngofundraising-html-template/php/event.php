...
<html lang="en">
	...
	<body>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-9 left-block event_page">
									...
									<div class="event_detail">
										<figure>
											<img src="assets/img/img_container.jpg" alt="img_container"/>
										</figure>
									    ...
									    <div class="event_heading clearfix">
										       <h2><a href="#">Event Heading here</a></h2>
										       <div class="event_time clearfix">
									              ...
									              <div class="event_descriptions">
									                 <p>lacinia at aliquam vel justo Phasellus felis purus placerat vel augue vitae aliquam tincidunt dolor Sed hendrerit diam in mattis mollis Donec ut tincidunt magn Nullam hendrerit pellentesque pellentesque Sed ultrices arcu leo arcu Aliquam erat volutpat Suspendisse eget congue justo  Class aptent taciti sociosqu ad litora torquent per conubia nostra per inceptos himenaeos Aliquam erat volutpat
                                                      </p>
                                                      
                                                      
                                                     <a href="event-details.html" class="btn btn-default">Read More</a>
                                                       </div>  
                                                  </div>
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/51eZ2IIPNas"  allowfullscreen></iframe>
										</div>
								...
								<div class="col-xs-12 col-sm-3 left-block ">
									<aside class="media">
										...
										<ul>
											<li>
												<a href="event-details.html" class="pull-left">
													<figure>
									...
									<aside class="media">
										<h3>Tags</h3>
										<ul class="archives tag_element clearfix">
											<li>
												<a href="#">tag One </a>
											</li>
											<li>
